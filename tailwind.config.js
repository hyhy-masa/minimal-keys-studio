...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        primary:
          "light-dark(oklch(55% 0.25 250), oklch(65.69% 0.196 285.75))",
        "primary-content":
          "light-dark(#FFFFFF, oklch(0.13138 0.0392 285.75))",
        secondary:
          "light-dark(oklch(60% 0.15 280), oklch(74.8% 0.26 342.55))",
        accent:
          "light-dark(oklch(70% 0.2 190), oklch(74.51% 0.167 183.61))",
